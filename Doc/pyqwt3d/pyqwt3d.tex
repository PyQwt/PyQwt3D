...
\newcommand{\NumPy}{\ulink{NumPy}
  {http://www.numpy.org}}
\newcommand{\NumPyTarGz}{\ulink{numpy-1.0}
...
\newcommand{\NewSip}{\ulink{sip-4.5.tar.gz}
...
\newcommand{\PyQtFGpl}{\ulink{PyQt4-x11-gpl-4.1.tar.gz}
  {http://pyqwt.sourceforge.net/support/PyQt-x11-gpl-4.1.tar.gz}}
\newcommand{\PyQtFMac}{\ulink{PyQt4-mac-gpl-4.1.tar.gz}
  {http://pyqwt.sourceforge.net/support/PyQt-mac-gpl-4.1.tar.gz}}
\newcommand{\PyQtCom}{\ulink{PyQt-commercial}
  {http://www.riverbankcomputing.co.uk/pyqt/buy.php}}
\newcommand{\PyQwtDddTarGz}{\ulink{PyQwt3D-0.1.3.tar.gz}
  {http://prdownloads.sourceforge.net/pyqwt/PyQwt3D-0.1.3.tar.gz?download}}
...
\newcommand{\Future}{
  \begin{notice}[warning]
    The documentation is for the future PyQwt3D-0.1.3 which is only available
    from CVS.
  \end{notice}
}
...
\begin{notice}[note]
  \file{PyQwt-0.1.3/GNUmakefile} is makefile for GNU make which contains more
