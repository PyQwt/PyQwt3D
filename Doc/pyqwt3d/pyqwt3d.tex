...
\newcommand{\NumPy}{\ulink{NumPy}
  {http://www.numpy.org}}
\newcommand{\NumPyTarGz}{\ulink{numpy-1.0.2}
...
\newcommand{\NewSip}{\ulink{sip-4.6.tar.gz}
...
\newcommand{\PyQtGpl}{\ulink{PyQt-x11-gpl-3.17.1.tar.gz}
  {http://pyqwt.sourceforge.net/support/PyQt-x11-gpl-3.17.1.tar.gz}}
\newcommand{\PyQtMac}{\ulink{PyQt-mac-gpl-3.17.1.tar.gz}
  {http://pyqwt.sourceforge.net/support/PyQt-mac-gpl-3.17.1/tar.gz}}
...
\newcommand{\PyQtFGpl}{\ulink{PyQt4-x11-gpl-4.2.tar.gz}
  {http://pyqwt.sourceforge.net/support/PyQt-x11-gpl-4.2.tar.gz}}
\newcommand{\PyQtFMac}{\ulink{PyQt4-mac-gpl-4.2.tar.gz}
...
\newcommand{\PyQwtNewExe}{\ulink{PyQwt3D-0.1.4-Python2.5-Qt4.2.3-PyQt-4.2-NumPy1.0.2.exe}
  {http://prdownloads.sourceforge.net/pyqwt/PyQwt3D-0.1.4-Python2.5-Qt4.2.3-PyQt-4.2-NumPy1.0.2.exe}}
...
\item
  \NewSip{}.\\
  Supported versions: SIP-4.6.x, and-4.5.x.\\
\item
  \PyQtGpl{}, \PyQtFGpl, \PyQtMac{}, \PyQtFMac{} or \PyQtCom{}.\\
  Supported versions: PyQt-4.2.x, and PyQt-4.1.x, or PyQt-3.17.x.\\
\item
  \QwtPlotDdd{}.\\
...
\begin{notice}[note]
  \file{PyQwt-0.1.4/GNUmakefile} is makefile for GNU make which contains more
