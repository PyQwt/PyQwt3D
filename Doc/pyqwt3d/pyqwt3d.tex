...
\item
  ...
  Python-2.5 requires \SipSnapShot{} (or the not yet released SIP-4.5).\\
\item
  \PyQtGpl{}, \PyQtFGpl, \PyQtMac{}, \PyQtFMac{} or \PyQtCom{}.\\
  Supported versions: PyQt-4.0.x, or PyQt-3.16.x.\\
  Python-2.5 requires \PyQtSnapShot{} or \PyQtFSnapShot{} (or the not yet
  released PyQt-4.1 or PyQt-3.17).\\
\item
  \QwtPlotDdd{}.\\
