...
\item
  ...
  and -- if you use PyQwt3D's patched version of QwtPlot3D -- Qt-2.3.x.
\item
  \NewSip{}.\\
  Supported versions: SIP-4.2, -4.1.1, -4.1, -4.0.1, and -4.0,
  but SIP-4.2.x is recommended. Only SIP-4.2.x is capable to wrap all of the
  advanced C++ idioms of QwtPlot3D without hacks.
  PyQwt3D looses some features, if you use SIP-4.1.x, and somewhat more if
  you use SIP-4.0.x.\\
...
\begin{notice}[note]
  The Makefile for GNU make, \file{PyQwt-0.1/Makefile}, contains more examples
  of how to invoke \file{configure.py}.  Adapt and use it, if you have GNU
  make.
\end{notice}
\begin{notice}[note]
...
The documentation supposes that you PyQwt3D has been built with SIP-4.2.0
or later.
