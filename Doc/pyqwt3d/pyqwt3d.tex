...
\begin{notice}[warning]
  Loading the PyQwt3D module -- compiled with MSCV-6.0 for Windows -- renders
  the Python interpreter unstable (PyQwt3D runs fine on MacOS/X and Linux).
  We are debugging with \QtNcExe{} and a backport of \QwtPlotDdd{} to Qt-2.3.
% (and assumes that MSVC-7.x
