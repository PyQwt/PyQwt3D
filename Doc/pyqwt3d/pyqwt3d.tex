...
\newcommand{\NumPy}{\ulink{NumPy}
  {http://www.numpy.org}}
\newcommand{\NumPyTarGz}{\ulink{numpy-0.9.5.tar.gz}
  {http://prdownloads.sourceforge.net/numpy/numpy-0.9.5.tar.gz?download}}
...
\newcommand{\NewSip}{\ulink{sip-4.3.2.tar.gz}
  {http://pyqwt.sourceforge.net/support/sip-4.3.2.tar.gz}}
\newcommand{\PyQtGpl}{\ulink{PyQt-x11-gpl-3.15.1.tar.gz}
  {http://pyqwt.sourceforge.net/support/PyQt-x11-gpl-3.15.1.tar.gz}}
\newcommand{\PyQtMac}{\ulink{PyQt-mac-gpl-3.15.1.tar.gz}
  {http://pyqwt.sourceforge.net/support/PyQt-mac-gpl-3.15.1.tar.gz}}
\newcommand{\PyQtCom}{\ulink{PyQt-commercial}
  {http://www.riverbankcomputing.co.uk/pyqt/buy.php}}
\newcommand{\PyQwtDddTarGz}{\ulink{PyQwt3D-0.1.1.tar.gz}
  {http://prdownloads.sourceforge.net/pyqwt/PyQwt3D-0.1.1.tar.gz?download}}
...
\newcommand{\NumPyExe}{\ulink{numpy-0.9.5.win32-py2.4.exe}
  {http://prdownloads.sourceforge.net/numpy/numpy-0.9.5.win32-py2.4.exe?download}}
\newcommand{\PyQtEdu}{\ulink{PyQt-win-edu-msvc-3.14.1.exe}
  {http://pyqwt.sourceforge.net/support/PyQt-win-edu-msvc-3.14.1.exe}}
...
\newcommand{\Future}{
  \begin{notice}[warning]
    The documentation is for the future PyQwt3D-0.1.1 which is only available
    from CVS.
  \end{notice}
}
...
\item
  ...
  Supported versions: Qt-3.3.x, Qt-3.2.x, or Qt-3.1.x.
\item
  \NewSip{}.\\
  Supported versions: SIP-4.3.x, or -4.2.1,
  but SIP-4.3.2 is recommended.\\
\item
  \PyQtGpl{}, \PyQtMac{} or \PyQtCom{}.\\
  Supported versions: PyQt-3.15.x, or -3.14.x,
...
\begin{notice}[note]
  \file{PyQwt-0.1.1/Makefile} is makefile for GNU make which contains more
...
\begin{notice}[note]
  The file \file{configure\textbackslash{}go.bat} is an example of
  how to automatize the invokations of \strong{configure.py}, \strong{nmake},
  and \strong{nmake install}.  Adapt and use it.
\end{notice}
