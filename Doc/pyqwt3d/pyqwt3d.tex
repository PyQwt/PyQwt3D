...
\newcommand{\PyQwtNewExe}{\ulink{PyQwt3D-0.1.5-Python2.5-Qt4.2.3-PyQt-4.2-NumPy1.0.3.exe}
  {http://prdownloads.sourceforge.net/pyqwt/PyQwt3D-0.1.5-Python2.5-Qt4.2.3-PyQt-4.2-NumPy1.0.3.exe}}
...
\begin{notice}[note]
  \file{PyQwt-0.1.5/GNUmakefile} is makefile for GNU make which contains more
